...
# YOU NEED A PARAGRAPH OR TWO THAT GETS OUT OF FAGA’ALU AND EXTRAPOLATES THESE DATA TO OTHER LOCATIONS, FOR MOST PEOPLE COULDN’T CARE LESS ABOUT FAGA’ALU. STATEMENT ABOUT HOW, COMBINED, THESE METHODS MAKE IT POSSIBLE TO GENERATE GREAT SPATIAL DATA NEEDED FOR UNDERSTANDING BIOLOGICALLY-RELEVANT PROCESSES (POSITIVE OR NEGATIVE) AND HOW THEY MIGHT VARY ACROSS THE REEF. THESE METHODS ALSO MAKE IT POSSIBLE TO EXTRAPOLATE THE FINDINGS OUT TO ANNUAL TIME SCALES TO DETERMINE BUDGETS BASED ON METEOROLOGIC AND OCEANOGRAPHIC (DEEPWATER) FORCING, IN THAT YOU COULD DETERMINE THERE ARE XXXX DAYS PER YEAR OF TIDAL FORCING CONDITIONS, YYYY OF WIND FORCING, AND ZZZZ OF WAVE FORCING. NEED MORE IN HERE ABOUT THE APPLICABILITY OF THESE DATA – GAS AND NUTRIENT FLUXES, LARVAL RECRUITMENT, ETC



document.add_paragraph("Like the atmospheric climate, global ocean circulation controls large-scale biophysical patterns such as nutrient and heat distributions. However, whereas atmospheric climate and global ocean circulation have been studied with remote-sensing methods, water circulation over small-scale reef ecosystems are similar to atmospheric micro-climates, and the long-term, synoptic observations of remote sensing have not been possible. Coral reefs are highly heterogeneous environments but ecologically important flow speeds and spatial patterns have been difficult to measure in relation to the long-term forcing conditions. The combination of spatially extensive Lagrangian drifters and temporally extensive Eulerian current meters presented here provides insight on the spatial patterns of flow within the context of variable forcing conditions. This approach can be used to extrapolate the findings from a targeted study period to seasonal, annual, or longer time scale, by determining the proportion of days that are dominated by tidal, wind, or wave forcing. A similar approach could be used to extrapolate the effects on reef flat circulation from future climate scenarios with changing storm frequencies and characteristics. For instance, a predicted increase in the strength and frequency of Southern Ocean storms (REF) could be extended to predict changing sediment dynamics, temperature regimes and nutrient cycling at the study site. The end-member forcing conditions could also be further refined to describe wave heights and wind speeds of varying magnitude, or combined with an empirical relationship accounting for varying tide stage, for finer-resolution predictive models of current speeds" )
