...
abstract = document.add_paragraph("Circulation is an important control on nutrient cycling, larval dispersal, and temperature variability, and understanding the impacts of terrestrial sediment, nutrients, and contaminants, on coral reef ecosystems. An experiment was conducted to characterize water flow patterns and residence times in relation to end-member forcing conditions in the fringing coral reef flat-lined embayment of Faga'alu on Tutuila in American Samoa. Lagrangian drifter deployments collected spatially-distributed flow data and Eulerian current profilers were installed at fixed locations to collect long-term flow data in relation to different forcing conditions. Mean current speeds (residence times) over the reef flat varied from 1-37 cm s-1 (0.1-2.8 hr), 1-36 cm s-1 (0.1-2.8  hr), and 5-64 cm s-1 (0.04-0.56 hr) under tidal, strong wind, and large wave forcing, respectively . The highest flow speeds and shortest residence times were observed over the exposed southern reef near the reef crest; the lowest flow speeds and longest residence times were consistently observed over the sheltered northern reef, close to shore in the embayment, and in the channel incised into the reef. During large wave forcing, flows followed a clockwise pattern onshore over the exposed southern reef onto the sheltered northern reef, and out to sea through the channel. Flow directions during tidal forcing were the most variable, with instances of transport from the reef flat to the fore reef; under onshore wind forcing, flow directions were mostly into the embayment. Lagrangian estimates of mean flow speeds were 70-139% higher than Eulerian estimates, due to the spatial heterogeneity in observed flows or the influence of Stokes drift on the surface drifters or both. These results demonstrate the applicability of a hybrid Lagrangian-Eulerian measurement scheme to understand spatially distributed, long-term flow patterns and thus residence time for biophysical studies in geomorphically-complex embayments that characterize many reef-lined coasts.")
