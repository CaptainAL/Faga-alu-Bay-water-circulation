...
document.add_paragraph("To characterize the spatial pattern of flows and determine the relationship between offshore wave forcing and residence time of water over the reef flat in Faga'alu Bay, a combination of Eulerian and Lagrangian measurements was used.")
...
document.add_paragraph(". It would seem that flow over the southern reef would flow directly into the main channel, however this flow is deflected away from the main channel, shoreward. This deflection is caused by wave energy refracting and surging into the main channel, pushing southward from the main channel onto the soouthern reef. ")
